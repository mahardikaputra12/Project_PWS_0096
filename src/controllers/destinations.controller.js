...
// GET destinations — dipakai baik oleh /api/v1/destinations (API key)
// maupun /app/destinations (sesi login JWT untuk browsing di website).
...
module.exports = { listDestinations, getDestinationDetail };
